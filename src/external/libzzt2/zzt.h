 ...
 *
 * Local modifications by Vince Patterson <vinceip532@gmail.com>
 * 2025/07/19
 * Added extern declarations for _zzt_display_char_table and
 * _zzt_display_char_line_table (tiles.c)
 * Added inline helper zzt_type_to_cp437()
 *
